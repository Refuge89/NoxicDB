...
-- Dumping structure for table arc_world.worldmap_info
...
-- Dumping data for table arc_world.worldmap_info: 135 rows
/*!40000 ALTER TABLE `worldmap_info` DISABLE KEYS */;
INSERT INTO `worldmap_info` (`entry`, `screenid`, `type`, `maxplayers`, `minlevel`, `minlevel_heroic`, `repopx`, `repopy`, `repopz`, `repopentry`, `area_name`, `flags`, `cooldown`, `lvl_mod_a`, `required_quest_1`, `required_quest_2`, `required_item`, `heroic_keyid_1`, `heroic_keyid_2`, `viewingDistance`, `required_checkpoint`) VALUES
	...
	(269, 212, 4, 5, 66, 70, -8750.83, -4193.51, -210.158, 1, 'Opening of the Dark Portal', 11, 0, 0, 10284, 10285, 0, 30635, 0, 500, 0),
	...
	(409, 192, 1, 40, 50, 0, -7510.56, -1036.7, 180.912, 0, 'Molten Core', 3, 604800, 0, 7848, 0, 0, 0, 0, 500, 0),
	...
	(469, 141, 1, 40, 60, 0, -7663.41, -1218.67, 287.798, 0, 'Blackwing Lair', 3, 604800, 0, 7761, 0, 0, 0, 0, 500, 0),
	...
	(658, 252, 4, 5, 75, 80, 5592.06, 2010.27, 798.181, 571, 'Pit of Saron', 21, 0, 0, 24511, 0, 0, 0, 0, 500, 0),
	(668, 253, 4, 5, 75, 80, 5628.88, 1973.29, 803.021, 571, 'Halls of Reflection', 21, 0, 0, 24712, 0, 0, 0, 0, 500, 0),
